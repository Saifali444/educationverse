<div class="left-sidenav">
                    ...
                    <ul class="metismenu left-sidenav-menu" id="side-nav">
                        ...
                        <li>
                            <a href="users.php"><i class="dripicons-user-group"></i><span>Users</span></a>
                        </li>
                          <li>
                            <a href="stream.php"><i class="far fa-address-book"></i><span>Stream</span></a>
                        </li>
                        
                        <li>
                            <a href="institute.php"><i class="far fa-building"></i><span>Institute</span></a>
                        </li>
                        
                          
                        <li>
                            <a href="program.php"><i class="mdi mdi-certificate"></i><span>Program</span></a>
                        </li>
                        
                         <li>
                            <a href="section.php"><i class="mdi mdi-certificate"></i><span>Section</span></a>
                        </li>
                          <li>
                            <a href="quiz.php"><i class="mdi mdi-certificate"></i><span>Quiz</span></a>
                        </li>
                        
                        
                        
                        
                          <li class="menu-title">Material</li>
