                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <div class="">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Update Institute</a></li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php
                                                ...
                                                $iid = $_GET['iid'];                                        
                                                $sql = "Select * From education_institute INNER JOIN education_stream ON education_institute.stream_id = education_stream.stream_id WHERE education_institute.institute_id='$iid'";
                                        ...
                                        ?>
                                                    ...
                                                    <form class="mt-4" method="POST" action="../backend/updateinstitute.php">
                                             
                                             
                                                   <input class="form-control" type="hidden" name="institute_id" id="example-text-input" value="<?= $row['institute_id']?>"> 
                                                       <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            <label for="example-text-input" class="col-sm-2 col-form-label text-right">Institute Name</label>
                                                            <div class="col-sm-10">
                                                                <input class="form-control" type="text" name="institute_name" id="example-text-input" value="<?= $row['institute_name']?>">
                                                            </div>
