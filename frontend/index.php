                                ...
                                <div class="row">
                                    <div class="col-8 align-self-center">
                                        <div class="">
                                            ...
                                            <p class="mb-0 text-muted"><span class="text-success"><i
                                                        class="mdi mdi-arrow-up"></i>14.5%</span> Up from yesterday</p>
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-4 align-self-center">
                                        <div class="icon-info text-right">
                                            ...
                                            <div class="row">
                                                <div class="col-12 align-self-center">
                                                    <div class="text-center">
                                                        <h4 class="mt-0 header-title text-left">Average Product Price
                                                        </h4>
                                                        ...
                                                        <p class="mb-1 text-muted"><span class="text-success"><i
                                                                    class="mdi mdi-arrow-up"></i>35.5%</span> Last 100
                                                            Subscriptions</p>
                                                    </div>
                                                </div><!--end col-->
                                            </div><!--end row-->
                                                ...
                                                <div class="col-12 align-self-center">
                                                    <div class="text-center">
                                                        ...
                                                        <p class="mb-1 text-muted"><span class="text-danger"><i
                                                                    class="mdi mdi-arrow-down"></i>1.5%</span> Down From
                                                            Last week</p>
                                                    </div>
                                                </div><!--end col-->
                                            </div><!--end row-->
                                            ...
                                            <div class="row">
                                                <div class="col-12 align-self-center">
                                                    <div class="text-center">
                                                        ...
                                                        <p class="mb-1 text-muted"><span class="text-success"><i
                                                                    class="mdi mdi-arrow-up"></i>11.1%</span> Up from
                                                            Last Month</p>
                                                    </div>
                                                </div><!--end col-->
                                            </div><!--end row-->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mt-2">
                                            <img src="../assets/images/flags/us_flag.jpg" alt="" class="mb-2"
                                                height="30">
                                            <h5 class="mb-3">Our most customers in America <span
                                                    class="badge badge-primary">March 2019</span></h5>
                                            <p class="font-13 text-muted mb-0"> But who has any right to find fault with
                                                a man who
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img class="" src="../assets/images/products/img-1.png" alt="user">
                                                </td>
                                                <td>
                                                    Beg
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="" src="../assets/images/products/img-2.png" alt="user">
                                                </td>
                                                <td>
                                                    Watch
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="" src="../assets/images/products/img-3.png" alt="user">
                                                </td>
                                                <td>
                                                    Headphone
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="" src="../assets/images/products/img-4.png" alt="user">
                                                </td>
                                                <td>
                                                    Purse
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="" src="../assets/images/products/img-5.png" alt="user">
                                                </td>
                                                <td>
                                                    Shoe
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="" src="../assets/images/products/img-6.png" alt="user">
                                                </td>
                                                <td>
                                                    Boll
                                                </td>
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="text-center">
                                                ...
                                                <p class="font-12 text-muted"><i class="fas fa-globe mr-2"></i>USA
                                                    Dealer</p>
                                                <p class="mb-0 text-muted">Contrary to popular belief, Lorem Ipsum is
                                        ...
                                        <div class="carousel-item">
                                            <div class="text-center">
                                                ...
                                                <p class="font-12 text-muted"><i class="fas fa-globe mr-2"></i>Russia
                                                    Dealer</p>
                                                <p class="mb-0 text-muted">Contrary to popular belief, Lorem Ipsum is
                                                    not simply random text. It has roots in a piece of classical Latin.
                                                </p>
                        ...
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body dash-info-carousel">
                                <div id="carousel_review" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <p class="px-4 py-1 bg-soft-success d-inline-block rounded">Very Good
                                                </p>
                                    ...
                                    <a class="carousel-control-prev" href="#carousel_review" role="button"
                                        data-slide="prev">
                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        <span class="sr-only">Previous</span>
                                    </a>
                                    <a class="carousel-control-next" href="#carousel_review" role="button"
                                        data-slide="next">
                                        <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                        <span class="sr-only">Next</span>
                                    </a>
