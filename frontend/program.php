                                                ...
                                                <td>
                                                        <div class="dropdown d-inline-block float-right">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dLabel9">
                                                                ...
                                                                <a class="dropdown-item" href="updateprogram.php?pid=<?= $row['program_id'] ?>">Update</a>
                                                                <a class="dropdown-item" href="../backend/deleteprogram.php?pid=<?= $row['program_id'] ?>">Delete</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                        </tr>
