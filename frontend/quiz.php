                    ...
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            <div class="float-right align-item-center mt-2">
                                            ...
                                            <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target=".bd-example-modal-xl">Add Quiz</button>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title mt-0" id="myModalLabel">Add Quiz </h5>
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="form-group row">
                                                         ...
                                                         <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label text-right">Select Section</label>
                                                            <div class="col-sm-10">
                                            ...
                                            <div class="col-lg-6">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="example-text-input" class="col-sm-2 col-form-label text-right">Quiz Name</label>
                                                            <div class="col-sm-10">
                                                                <input class="form-control" type="text" name="Quiz_Name" id="example-text-input">
                                                            </div>
