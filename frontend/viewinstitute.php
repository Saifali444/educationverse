                                    ...
                                    <div class="card-body">
                                        ...
                                        if ($result->num_rows > 0) {
                                          ...
                                          ?>
                                                  ...
                                                  <div class="row">
                                                      <div class="col-md-3">
                                                          <h4>Institute Spokeperson:</h4>
                                                      </div>
                                                        <div class="col-md-3">
                                                          <h4><?= $row['institue_spokeperson']?></h4>
                                                      </div>
                                                       <div class="col-md-3">
                                                          <h4>Institute Email:</h4>
                                                      </div>
                                                        <div class="col-md-3">
                                                          <h4><?= $row['institute_email']?></h4>
                                                      </div>
                                                     ...
                                                     <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                          <h4><?= $row['institute_contact']?></h4>
                                                      </div>
                                                      <div class="col-md-3">
                                                          <h4>Institute Code:</h4>
                                                      </div>
                                                        <div class="col-md-3">
                                                          <h4><?= $row['institute_code']?></h4>
                                                      </div>
