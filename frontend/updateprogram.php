                ...
                <div class="page-content">
                    <div class="container-fluid"> 
                        <div class="row">
                           ...
                           <form method="POST" action="../backend/updateprogram.php">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-control" type="text" name="Program_Name" id="example-text-input" value="<?= $row['program_name']?>">
                                                            </div>
                                                       
                                                         </div>
                                                         
                                                         
                                                          <input class="form-control" type="hidden" name="program_id" id="example-text-input" value="<?= $pid ?>">
                                                         
                                                        <div class="form-group row">
                                                            <label for="example-text-input" class="col-sm-2 col-form-label text-right">Program Duration</label>
                                                            <div class="col-sm-10">
                                                                <input class="form-control" type="text" name="Program_Duration" id="example-text-input" value="<?= $row['program_duration']?>">
                                                            </div>
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select class="form-control" name="Program_status">
                                                                    <option>Select</option>
                                                                      ...
                                                                      <option Value="ACTIVE" <?php if($row['program_status']=="ACTIVE"){
                                                                                   echo "selected";
                                                                                  } ?>>Active</option>
                                                                      <option Value="INACTIVE" <?php if($row['program_status']=="INACTIVE"){
                                                                                   echo "selected";
                                                                                  } ?>>DeActive</option>
                                            ...
                                            <div class="col-lg-6">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select class="form-control" name="Education_institute">
                                                                    <option>Select</option>
                                                                                                                                                          ...
                                                                                                                                                          <?php
                                                                            $sql2 = "SELECT * FROM `education_institute`";
                                                                      ...
                                                                      <option Value="<?= $row2['institute_id']?>" <?php if($row['institute_name']==$row2['institute_name']){
                                                                                   echo "selected";
                                                                                  } ?>><?= $row2['institute_name']?></option>
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-control" type="text" name="Program_Code" id="example-text-input" value="<?= $row['program_code']?>">
                                                            </div>
                                                       ...
                                                       <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-control" type="text" name="Program_Fee" id="example-text-input" value="<?= $row['program_fees']?>">
                                                            </div>
